...
const Home = ({ navigation }) => {
  const [trending, setTranding] = useState(dummyData.trendingCurrencies);
    ...
    return (
      ...
      >
        ...
        >
          ...
          is volatile. Learn how to use dollar cost averaging to your adventage.
        </Text>
  ...
  function renderTransactionHistory() {
    return (
      <TransactionHistory
        coustomContainerStyle={{ ...styles.shadow }}
